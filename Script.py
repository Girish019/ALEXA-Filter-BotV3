...
class script(object):
    ...
    NEW_GRP_START = """ɪ ᴀᴍ sᴜᴄᴄᴇssғᴜʟʟʏ ᴊᴏɪɴᴇᴅ ʏᴏᴜʀ ɢʀᴏᴜᴘ **{}**
    
**ɪғ ʏᴏᴜ ᴀʀᴇ ᴀɴ ᴀᴅᴍɪɴ ᴏғ ᴛʜɪs ɢʀᴏᴜᴘ ᴛʜᴀɴ ᴄᴏɴɴᴇᴄᴛ ᴀɴᴅ ᴍᴀɴᴀɢᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ 
/connect**
...
ᴍᴀʏ ʙᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ ғɪʟᴇs ᴀʀᴇ ɴᴏᴛ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ

ᴅɪsᴄᴜss ᴛʜᴇ ǫᴜɪʀʏ ᴡɪᴛʜ ᴍʏ ᴀᴅᴍɪɴ
</b>"""
...
ᴍᴏᴠɪᴇ: Kgf or Kgf Telugu
ꜱᴇʀɪᴇꜱ : Loki S01 or Loki S01E04 or Lucifer S03E24
and 🚯ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)
                   or
ᴅɪsᴄᴜss ᴛʜᴇ ǫᴜɪʀʏ ᴡɪᴛʜ ᴍʏ ᴀᴅᴍɪɴ
</b>"""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ...</b>"""
    ...
    MVE_NT_FND = """<b>sᴏʀʀʏ, ᴛʜᴇ Mᴏᴠɪᴇ '{}' ɪs ɴᴏᴛ ʀᴇʟᴇᴀsᴇᴅ or ɴᴏᴛ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ...
    
ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴀᴅᴍɪɴ ᴀɴᴅ ᴅɪsᴄᴜss ʏᴏᴜʀ ǫᴜᴇʀʏ </b>"""
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த Alexa Movie Finder 🔍 போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this Alexa Movie Finder 🔍 bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ Alexa Movie Finder 🔍 బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस Alexa Movie Finder 🔍 बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ Alexa Movie Finder 🔍 ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Alexa Movie Finder 🔍 بوٹ کا انتظام کریں۔
...
ಹೇ <a href='tg://settings'>My Friend</a>
 ...
 ಹಂತ 1: ಈ Alexa Movie Finder 🔍 ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Alexa Movie Finder 🔍 বট পরিচালনা করুন
