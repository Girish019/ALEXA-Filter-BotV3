...
SHORTLINK_API = environ.get('SHORTLINK_API', 'XmhEQlgw7Ver0s8aIQ6Ef4VOcUu1')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/firelinksguide')
...
URL = "https://alexa-filter-botv2.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://alexa-filter-botv2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://alexa-filter-botv2.onrender.com/".format(FQDN)
else:
    URL = "https://alexa-filter-botv2.onrender.com/".format(FQDN)
