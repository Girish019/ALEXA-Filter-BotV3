...
from utils import write_cap, get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, get_tutorial, send_all, get_cap
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {u_men} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇\n\n ᴏʀ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ʀᴇsᴘᴇᴄᴛɪᴠᴇ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴀᴅᴍɪɴ ʀɪɢʜᴛ ᴛᴏ ᴜsᴇ ᴍᴇ</b>",   
    ...
    if gl == False:
        ...
        if k == False:
            ...
            if files:
                ...
                butn = [[InlineKeyboardButton("ᴄᴏɴᴛᴀᴄᴛ ᴀᴅᴍɪɴ", url=f"https://t.me/{SUPPORT_CHAT}")]]
                k = await query.message.reply_to_message.reply_photo(
                photo=REST_NOT_FND, 
                caption=script.MVE_NT_FND.format(movie),
                reply_markup=InlineKeyboardMarkup(butn)
                )
                if NO_RESULTS_MSG:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    elif query.data == "disablestream":
        await query.answer(text=script.DISABLESTREAM, show_alert=True)
