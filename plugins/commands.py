                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'disablestream')
        ...
        try:
            ...
            if CUSTOM_FILE_CAPTION:
                try:
                    ...
                    # f_caption=CUSTOM_FILE_CAPTION.format(file_name= title if title is None else get_cap[2], audio = 'NOT FOUND' if title is None else get_cap[0], file_size='' if size is None else size, file_caption='')
                except:
                    return
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Example:-\n/shortlink upshrink.com db8e518b1e15d2184e0dfe7467a6e6e92f4ccbf4\n\nThat's it!!! Enjoy Earning Money 💲\n\nIf you have any Doubts, Feel Free to Ask me - @AMsuporttbot</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
