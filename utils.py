...
def write_cap(f_name, cap):
    ...
    for i, item in enumerate(my_list):
        if item in reps.keys():
            my_list[i] = reps[item]
            final = " ".join([str(i) for i in my_list])[8:-1]
